...
$(function () {
    ...
    $('.projects-item').each(function () {
       ...
       $(this).prepend('<div class="projects-item-num">0'+projectNum+'</div>');
    });
    ...
    $('.btn-more').on('click', function () {
        $('html,body').animate({scrollTop: $(this).closest('section').next().offset().top - 136},'slow');
    });
    ...
    $('.products-filter-block-more').on('click', function () {
        $(this).closest('.products-filter-block').toggleClass('open');
    });

    $('button.products-filter-block-title').on('click', function () {
        $(this).closest('.products-filter-block').removeClass('closed');
    });
