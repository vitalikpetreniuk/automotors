...
$(function () {
    ...
    $(window).on('resize', function () {
        ...
        if(windowScrollTop > 0){
            $('.header, .eng-header').addClass('fixed');
        }else{
            $('.header, .eng-header').removeClass('fixed');
        }
    ...
    $('.modal-open').on('click touchstart', function (e) {
    ...
    $('.btn-more, .eng-more').on('click', function () {
    ...
    var navbarHeightEng = $('.eng-header').outerHeight();
    ...
    function hasScrolled() {
        ...
        if (st > lastScrollTop && st > navbarHeightEng){
            $('.eng-header').removeClass('header-down');
        } else {
            if(st + $(window).height() < $(document).height()) {
                $('.eng-header').addClass('header-down');
            }
        }
    ...
    $('.header-toggle').on('click', function () {
       $('.header, .eng-header').toggleClass('open');
       $('.header-menu, .eng-menu').slideToggle('fast');
    });
    ...
    $('.eng-top-slider').owlCarousel({
        items: 1
    });

    $('.eng-projects-slider').owlCarousel({
        items: 1,
        mouseDrag: false,
        dots: false,
        nav: true,
    ...
    $('.eng-header-toggle').on('click', function () {
    ...
    $('.menu-scroll ul a').on('click', function (e) {
        e.preventDefault();
